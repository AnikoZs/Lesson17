...
public class AppleFarm {
    private static ArrayList<AppleImproved> inventory = new ArrayList<>();
    ...
    private static void addApples() {
        inventory.add(new AppleImproved("Honey Crisp", 3, 8.5, "Rød"));
        inventory.add(new AppleImproved("Belle de Boskoop", 1, 6.2, "Grøn"));
        inventory.add(new AppleImproved("Cox Orange", 2, 7.8, "Orange"));
        inventory.add(new AppleImproved("Ingrid Marie", 3, 9.0, "Gul"));
        inventory.add(new AppleImproved("Pigeon", 2, 7.0, "Pink"));
    }
    ...
    private static void viewInventory() {
        if (inventory.isEmpty()) {
            ...
            for (AppleImproved apple : inventory) {
